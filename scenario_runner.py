...
class ScenarioRunner(object):
    ...
    def __init__(self, args):
        ...
        self.traffic_manager.global_percentage_speed_difference(-30.0) #제한보다 30퍼센트 빠른 속도로 주행 jiwoo
        ...
        logging.basicConfig(filename='_out/scenario.log', level=logging.INFO, format='%(asctime)s %(message)s') #jiwoo
